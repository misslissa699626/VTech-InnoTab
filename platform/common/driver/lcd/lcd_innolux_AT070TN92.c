...
// H-Sync
#define	HD_PULSE_W		20
#define	HD_PULSE_POL	0
#define	HD_FRONT_P		210 +1
#define	HD_BACK_P			46 -1
// V-Sync
#define	VD_PULSE_W		10
#define	VD_PULSE_POL	0
#define	VD_FRONT_P		22	+1
#define	VD_BACK_P			23	-1
// Panel Size unit:mm
 ...
 *                         G L O B A L    D A T A                         *
 **************************************************************************/
static const char gPanelName[] = "LCD_Innolux_AT070TN92";
