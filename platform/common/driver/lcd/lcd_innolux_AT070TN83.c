...
/*!
 * @file lcd_innolux_AT070TN83.h
 * @brief The lcd driver of Innolux AT070TN83
 */
 ...
 *                         G L O B A L    D A T A                         *
 **************************************************************************/
static const char gPanelName[] = "LCD_Innolux_AT070TN83";
...
#if 0
	/* Set dither */
	dispSetDitherType(gPanelInfo.ditherType);
	dispSetDitherParam(gPanelInfo.pDitherParam);
	dispSetDitherEnable(0);

	/* Set color matrix */
	dispSetColorMatrix(gPanelInfo.pColorMatrix);
#endif
...
// Disable LCD bus output
	scu_change_pin_grp(6, 0);
	scu_change_pin_grp(8, 0);
	scu_change_pin_grp(9, 0);
	scu_change_pin_grp(10, 0);
	scu_change_pin_grp(7, 0);
