...
)
{
	...
	pCsiReg->csicr0 =0x01|(1<<1)|(0<<2)|(0<<3)|(0<<4)|(1<<5)|(1<<8)|(1<<9)|(1<<10)|(0<<11)|(2<<20)|(1<<31); //tvp5150
	//pCsiReg->csicr0 =0x01|(0<<1)|(1<<2)|(1<<3)|(0<<5)|(1<<8)|(1<<9)|(1<<10)|(0<<11)|(1<<31);//mt9d112
	pCsiReg->csicr0&=(~(1<<27));
