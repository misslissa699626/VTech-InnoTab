 ...
 *                                                                        *
 **************************************************************************/
//5:4  use preview config0;
//16:9 use preview config1;
//4:3  use preview config2;
//manual set: use preview config3;
...
#define C_SS6AA_FMT		C_SS6AA_YUYV//C_SS6AA_YVYU	
...
{ 0x002A, 0x0488 },
{ 0x0F12, 0x3390 },	//lt_uMaxExp1 50.0ms *400 =20000
{ 0x0F12, 0x0000 },
{ 0x0F12, 0x9C40 },	//lt_uMaxExp2 100ms
{ 0x0F12, 0x0000 },
...
{ 0x002A, 0x0490 },	
{ 0x0F12, 0x3390 },	//lt_uCapMaxExp1 416E:33.3m
{ 0x0F12, 0x0000 },
{ 0x0F12, 0x9C40 },	//lt_uCapMaxExp2
{ 0x0F12, 0x0000 },
...
{ 0x002A, 0x0498 },
{ 0x0F12, 0x0210 },	//lt_uMaxAnGain1 
{ 0x0F12, 0x0330 },	//lt_uMaxAnGain2
{ 0x002A, 0x2368 },
{ 0x0F12, 0x06d0 },	//AWBBTune_EVT4_uMaxAnGain3  700 800 900 990 A00	
{ 0x002A, 0x049C },
{ 0x0F12, 0x0100 },	//lt_uMaxDigGain

{ 0x002A, 0x235C },
{ 0x0F12, 0x0002 },	//AWBBTune_EVT4_uMinCoarse //0001	
...
{ 0x0F12, 0x0001 }, //SARR_usGammaLutRGBIndoor_0__1_ 
{ 0x0F12, 0x0005 }, //SARR_usGammaLutRGBIndoor_0__2_ 
{ 0x0F12, 0x000B }, //SARR_usGammaLutRGBIndoor_0__3_ 
{ 0x0F12, 0x0071 }, //SARR_usGammaLutRGBIndoor_0__4_ 
{ 0x0F12, 0x00FE }, //SARR_usGammaLutRGBIndoor_0__5_ 
...
{ 0x0F12, 0x0001 }, //SARR_usGammaLutRGBIndoor_1__1_ 
{ 0x0F12, 0x0005 }, //SARR_usGammaLutRGBIndoor_1__2_ 
{ 0x0F12, 0x000B }, //SARR_usGammaLutRGBIndoor_1__3_ 
{ 0x0F12, 0x0071 }, //SARR_usGammaLutRGBIndoor_1__4_ 
{ 0x0F12, 0x00FE }, //SARR_usGammaLutRGBIndoor_1__5_ 
...
{ 0x0F12, 0x0001 }, //SARR_usGammaLutRGBIndoor_2__1_ 
{ 0x0F12, 0x0005 }, //SARR_usGammaLutRGBIndoor_2__2_ 
{ 0x0F12, 0x000B }, //SARR_usGammaLutRGBIndoor_2__3_ 
{ 0x0F12, 0x0071 }, //SARR_usGammaLutRGBIndoor_2__4_ 
{ 0x0F12, 0x00FE },	//SARR_usGammaLutRGBIndoor_2__5_ 
...
{ 0x002A, 0x0D08 },
{ 0x0F12, 0x026A },	//0250	//awbb_OutdoorGrZones_m_BGrid[0]
{ 0x0F12, 0x0280 },	//0260	//awbb_OutdoorGrZones_m_BGrid[1]
{ 0x0F12, 0x025E },	//0245	//awbb_OutdoorGrZones_m_BGrid[2]
{ 0x0F12, 0x028C },	//026B	//awbb_OutdoorGrZones_m_BGrid[3]
{ 0x0F12, 0x0250 },	//023A	//awbb_OutdoorGrZones_m_BGrid[4]
{ 0x0F12, 0x0290 },	//026D	//awbb_OutdoorGrZones_m_BGrid[5]
{ 0x0F12, 0x0246 },	//0230	//awbb_OutdoorGrZones_m_BGrid[6]
{ 0x0F12, 0x0290 },	//026F	//awbb_OutdoorGrZones_m_BGrid[7]
{ 0x0F12, 0x023C },	//0226	//awbb_OutdoorGrZones_m_BGrid[8]
{ 0x0F12, 0x0290 },	//026F	//awbb_OutdoorGrZones_m_BGrid[9]
{ 0x0F12, 0x0234 },	//0221	//awbb_OutdoorGrZones_m_BGrid[10]
{ 0x0F12, 0x028E },	//026A	//awbb_OutdoorGrZones_m_BGrid[11]
{ 0x0F12, 0x022A },	//021D	//awbb_OutdoorGrZones_m_BGrid[12]
{ 0x0F12, 0x028C },	//0264	//awbb_OutdoorGrZones_m_BGrid[13]
{ 0x0F12, 0x021E },	//0217	//awbb_OutdoorGrZones_m_BGrid[14]
{ 0x0F12, 0x0286 },	//0260	//awbb_OutdoorGrZones_m_BGrid[15]
{ 0x0F12, 0x0214 },	//0210	//awbb_OutdoorGrZones_m_BGrid[16]
{ 0x0F12, 0x0280 },	//0259	//awbb_OutdoorGrZones_m_BGrid[17]
{ 0x0F12, 0x020E },	//020A	//awbb_OutdoorGrZones_m_BGrid[18]
{ 0x0F12, 0x0278 },	//0251	//awbb_OutdoorGrZones_m_BGrid[19]
{ 0x0F12, 0x020A },	//0204	//awbb_OutdoorGrZones_m_BGrid[20]
{ 0x0F12, 0x0272 },	//024B	//awbb_OutdoorGrZones_m_BGrid[21]
{ 0x0F12, 0x0204 },	//01FD	//awbb_OutdoorGrZones_m_BGrid[22]
{ 0x0F12, 0x026C },	//0245	//awbb_OutdoorGrZones_m_BGrid[23]
{ 0x0F12, 0x0200 },	//01F6	//awbb_OutdoorGrZones_m_BGrid[24]
{ 0x0F12, 0x0264 },	//023E	//awbb_OutdoorGrZones_m_BGrid[25]
{ 0x0F12, 0x01FE },	//01F1	//awbb_OutdoorGrZones_m_BGrid[26]
{ 0x0F12, 0x025E },	//0238	//awbb_OutdoorGrZones_m_BGrid[27]
{ 0x0F12, 0x01FE },	//01EC	//awbb_OutdoorGrZones_m_BGrid[28]
{ 0x0F12, 0x0258 },	//022F	//awbb_OutdoorGrZones_m_BGrid[29]
{ 0x0F12, 0x01FE },	//01E9	//awbb_OutdoorGrZones_m_BGrid[30]
{ 0x0F12, 0x0252 },	//0219	//awbb_OutdoorGrZones_m_BGrid[31]
{ 0x0F12, 0x0200 },	//01EF	//awbb_OutdoorGrZones_m_BGrid[32]
{ 0x0F12, 0x0238 },	//01F8	//awbb_OutdoorGrZones_m_BGrid[33]
{ 0x0F12, 0x0204 },	        //awbb_OutdoorGrZones_m_BGrid[34]
{ 0x0F12, 0x0224 },	        //awbb_OutdoorGrZones_m_BGrid[35]
...
{ 0x002A, 0x0D74 },
{ 0x0F12, 0x020E },	//awbb_OutdoorGrZones_m_Boffs   Don't modify  021F:2F	
{ 0x0F12, 0x0000 },
{ 0x002A, 0x0E00 },
...
{ 0x0F12, 0x01E0 },	//01B6 ////0198 ////01D6 ////01E0 ////01B7	//CW//2410
{ 0x0F12, 0xFFB9 },	//FFDE ////FFF1 ////FFBD ////FFB9 ////FFD0
...
{ 0x0F12, 0x01B3 },	//01B6 ////01AC
{ 0x0F12, 0xFFE7 },	//FFDE ////FFE4
{ 0x0F12, 0xFFF9 },	//0003 ////0008
{ 0x0F12, 0x00CB },	//00CB ////00C5
{ 0x0F12, 0x00F3 },	//00F3 ////00E3
{ 0x0F12, 0xFF4C },	//FF4C ////FF5D
{ 0x0F12, 0xFF66 },	//ff20 ////FF33
{ 0x0F12, 0x01AB },	//01bb ////019C
{ 0x0F12, 0xFF43 },	//ff79 ////FF85
...
{ 0x0F12, 0x01AE },	//01AA //01B9 //TVAR_wbt_pOutdoorCcm[0]
{ 0x0F12, 0xFFB9 },	//FFB9 //FFBC //TVAR_wbt_pOutdoorCcm[1]
{ 0x0F12, 0x0017 },	//001E //0012 //TVAR_wbt_pOutdoorCcm[2]
...
{ 0x0F12, 0x0016 },	//SARR_uNormBrInDoor[0] 000A	
{ 0x0F12, 0x0028 },	//SARR_uNormBrInDoor[1] 0019	
{ 0x0F12, 0x0096 },	//SARR_uNormBrInDoor[2] 0096	
{ 0x0F12, 0x01F4 },	//SARR_uNormBrInDoor[3] 01F4	
{ 0x0F12, 0x07D0 },	//SARR_uNormBrInDoor[4] 07D0	
...
{ 0x002A, 0x0828 },	             
{ 0x0F12, 0x0008 },	//TVAR_afit_pBaseVals[0]     70000828  //BRIGHTNESS                                                                
{ 0x0F12, 0x0003 }, //TVAR_afit_pBaseVals[1]     7000082A  //CONTRAST                                                                  
{ 0x0F12, 0x0010 },	//TVAR_afit_pBaseVals[2]     7000082C  //SATURATION                                                                
...
{ 0x0F12, 0x0180 },	//TVAR_afit_pBaseVals[57]    7000089A  //"CCM_Oscar_iSaturationCCM_Oscar_bSaturation"   014C	                           
...
{ 0x0F12, 0x0013 },	//TVAR_afit_pBaseVals[62]    700008A4  //RGB2YUV_iYOffset 15 18 001a 05 A	
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[63]    700008A6  //BRIGHTNESS                                                                
{ 0x0F12, 0x0003 }, //TVAR_afit_pBaseVals[64]    700008A8  //CONTRAST    0028	                                                               
{ 0x0F12, 0x0010 },	//TVAR_afit_pBaseVals[65]    700008AA  //SATURATION                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[66]    700008AC  //SHARP_BLUR                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[67]    700008AE  //GLAMOUR
{ 0x0F12, 0x03FF },	//TVAR_afit_pBaseVals[68]    700008B0  //Disparity_iSatSat 03FF	                                                        
{ 0x0F12, 0x000C },	//TVAR_afit_pBaseVals[69]    700008B2    //Denoise1_iYDenThreshLow 0E 0C	20	
...
{ 0x0F12, 0x101E },	//101E	//TVAR_afit_pBaseVals[110]   70000904    //"DSMix1_iLowPower_FineDSMix1_iLowPower_Fine_Bin"  14 1E                         
...
{ 0x0F12, 0x000A },	//TVAR_afit_pBaseVals[125]   70000922    //RGB2YUV_iYOffset  07 00 	
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[126]   70000924    //BRIGHTNESS                                                                
{ 0x0F12, 0x0003 }, //TVAR_afit_pBaseVals[127]   70000926    //CONTRAST    24	                                                                 
{ 0x0F12, 0x000e },	//TVAR_afit_pBaseVals[128]   70000928    //SATURATION                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[129]   7000092A    //SHARP_BLUR                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[130]   7000092C    //GLAMOUR
{ 0x0F12, 0x03FF },	//TVAR_afit_pBaseVals[131]   7000092E    //Disparity_iSatSat  03FF	                                                       
{ 0x0F12, 0x000A },	//TVAR_afit_pBaseVals[132]   70000930    //Denoise1_iYDenThreshLow 08 0E	
{ 0x0F12, 0x0006 },	//TVAR_afit_pBaseVals[133]   70000932    //Denoise1_iYDenThreshLow_Bin 06	
{ 0x0F12, 0x0040 },	//TVAR_afit_pBaseVals[134]   70000934    //Denoise1_iYDenThreshHigh 50 64	
...
{ 0x0F12, 0x1611 },	//TVAR_afit_pBaseVals[170]   7000097C    //"DSMix1_iLowPower_Wide_BinDSMix1_iHighPower_Wide"   //0f11 //1911	//1911	                      
{ 0x0F12, 0x0A0F },	//TVAR_afit_pBaseVals[171]   7000097E    //"DSMix1_iHighPower_Wide_BinDSMix1_iLowThresh_Wide"  //0A0F	                      
{ 0x0F12, 0x050A },	//TVAR_afit_pBaseVals[172]   70000980    //"DSMix1_iHighThresh_WideDSMix1_iReduceNegativeWide" //050A	                      
{ 0x0F12, 0x2025 },	//TVAR_afit_pBaseVals[173]   70000982    //"DSMix1_iLowPower_FineDSMix1_iLowPower_Fine_Bin"         //14 //28	//2028	                 
{ 0x0F12, 0x2025 },	//TVAR_afit_pBaseVals[174]   70000984    //"DSMix1_iHighPower_FineDSMix1_iHighPower_Fine_Bin"       //1e //28	//2028	                 
...
{ 0x0F12, 0x0003 }, //TVAR_afit_pBaseVals[190]   700009A4    //CONTRAST     001e	                                                             
{ 0x0F12, 0x000e },	//TVAR_afit_pBaseVals[191]   700009A6    //SATURATION                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[192]   700009A8    //SHARP_BLUR                                                                
{ 0x0F12, 0x0000 },	//TVAR_afit_pBaseVals[193]   700009AA    //GLAMOUR
{ 0x0F12, 0x03FF },	//TVAR_afit_pBaseVals[194]   700009AC    //Disparity_iSatSat  03FF	                                                       
{ 0x0F12, 0x000A },	//TVAR_afit_pBaseVals[195]   700009AE    //Denoise1_iYDenThreshLow  0e 08                                                 
{ 0x0F12, 0x0006 },	//TVAR_afit_pBaseVals[196]   700009B0    //Denoise1_iYDenThreshLow_Bin
{ 0x0F12, 0x0040 },	//TVAR_afit_pBaseVals[197]   700009B2    //Denoise1_iYDenThreshHigh   50	64	                                               
...
{ 0x0F12, 0x1611 },	//1911	//TVAR_afit_pBaseVals[233]   700009FA    //"DSMix1_iLowPower_Wide_BinDSMix1_iHighPower_Wide"  0f11                        
...
{ 0x0F12, 0x2025 },	//2028  //TVAR_afit_pBaseVals[236]   70000A00    //"DSMix1_iLowPower_FineDSMix1_iLowPower_Fine_Bin"     //14 //28		                     
{ 0x0F12, 0x2025 },	//2028  //TVAR_afit_pBaseVals[237]   70000A02    //"DSMix1_iHighPower_FineDSMix1_iHighPower_Fine_Bin"   //1E //28	                     
...
{ 0x0F12, 0x0003 }, //TVAR_afit_pBaseVals[253]   70000A22                //CONTRAST      //000a	                                                            
{ 0x0F12, 0x000e },	//TVAR_afit_pBaseVals[254]   70000A24                //SATURATION                                                                
...
{ 0x0F12, 0x1611 },	//TVAR_afit_pBaseVals[296]   70000A78                //"DSMix1_iLowPower_Wide_BinDSMix1_iHighPower_Wide"   //0f11 //1911	                      
...
{ 0x0F12, 0x2020 },	//TVAR_afit_pBaseVals[299]   70000A7E                //"DSMix1_iLowPower_FineDSMix1_iLowPower_Fine_Bin"    //14 //20	                      
{ 0x0F12, 0x2020 },	//TVAR_afit_pBaseVals[300]   70000A80                //"DSMix1_iHighPower_FineDSMix1_iHighPower_Fine_Bin"  //1e //20	                      
...
{ 0x0F12, 0x0180 },	//TVAR_afit_pBaseVals[309]   70000A92 				 //"CCM_Oscar_iSaturationCCM_Oscar_bSaturation"  //180 173 164                              
{ 0x0F12, 0x0180 },	//TVAR_afit_pBaseVals[310]   70000A94                //"RGBGamma2_iLinearityRGBGamma2_bLinearity"    //Linearity 
...
//===============================================================
	{ 0x002A, 0x03FA },
	{ 0x0F12, 0x0001 }, //MIPI Lanes number
	{ 0x0F12, 0x00C3 },
	{ 0x0F12, 0x0001 },
	...
	{ 0x0F12, 0x0000 },                                         
	{ 0x002A, 0x01C6 },                                     
	{ 0x0F12, 0x0000 },  //PLL Number                                     
	{ 0x0F12, 0x0002 },  //MIPI Number   //1 PLL configurations
	
	{ 0x002A, 0x01CC },                                     
	{ 0x0F12, 0x1B58 },  //Preview 0 system clk 0x1b58:7M     0x2EE0:12M
	{ 0x0F12, 0x30D4 },  //0 Min PLCK   0x30D4:12.5M  0x2Ed0                                 
	{ 0x0F12, 0x30D4 },  //0 Max PLCK   0x30D4:12.5M  0x2ef0

	{ 0x0F12, 0x1B58 },  //Capture 1 System clk
	{ 0x0F12, 0x30D4 },  //1 Min PLCK
	{ 0x0F12, 0x30D4 },  //1 Max PLCK

//	{ 0x0F12, 0x1B58 },  //Capture 1 System clk 1b58:7000 1d4c:7500 1f40:8000 2134:8500
//	{ 0x0F12, 0x157c },  //1 Min PLCK
//	{ 0x0F12, 0x157c },  //1 Max PLCK

	{ 0x002A, 0x01E0 },
	{ 0x0F12, 0x0001 },
////////////////////////////////////////////////////////preview 
//initional preview configure 3
	{ 0x002A, 0x02B4 }, 
	{ 0x0F12, 0x0280 }, //preview 3 width
	{ 0x0F12, 0x01E0 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M  30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
	{ 0x0F12, 0x0000 }, //clockind  02c0
	{ 0x0F12, 0x0002 },//frame time type
	{ 0x0F12, 0x0001 },//frame quality
	{ 0x0F12, 0x0168 }, //max frame time  0X3E8:10FPS 1F4:20FPS 14F:30FPS
	{ 0x0F12, 0x0168 }, //min frame time
	{ 0x0F12, 0x0000 }, //Saturation
	{ 0x0F12, 0x0000 }, //sharpness
	{ 0x0F12, 0x0000 }, //gamma
	{ 0x0F12, 0x0000 }, //color temp
	{ 0x0F12, 0x0000 }, //device gamma index
	{ 0x002A, 0x02D4 }, 
	{ 0x0F12, 0x0000 }, //preview mirror value:[0-3]
	{ 0x0F12, 0x0000 }, //capture mirror
////////////////////////////////////////////////////////
...
regval16_t ss6AA_output_1280x1024_table[] =
{
//return to 5:4 full screen
	{0x0028,    0x7000 },
	{0x002A, 	0x020A },	//#REG_TC_GP_PrevZoomReqInputWidth
	{0x0F12, 	0x0500 },
	{0x002A, 	0x020c },	//#REG_TC_GP_PrevZoomReqInputHeight
	{0x0F12, 	0x0400 },
	{0x0F12, 	0x0000 },
	{0x0F12, 	0x0000 },

	{0x002A, 	0x01FA },	//#REG_TC_GP_PrevReqInputWidth
	{0x0F12, 	0x0500 },
	{0x002A, 	0x01FC },	//#REG_TC_GP_PrevReqInputHeight
	{0x0F12, 	0x0400 },
	{0x002A,	0x01FE },	//#REG_TC_GP_PrevInputWidthOfs
	{0x0F12,	0x0000 },
	{0x002A,	0x0200 },	//#REG_TC_GP_PrevInputHeightOfs	//centered 
	{0x0F12,	0x0000 },	

	{ 0xffff, 0xffff },
};

regval16_t ss6AA_output_1280x720_table[] =
{
	{0x0028,    0x7000 },
	  //cut screen to 16:9
	{0x002A, 	0x020A },	//#REG_TC_GP_PrevZoomReqInputWidth
	...
	{0x002A, 	0x021A },//#REG_TC_GP_InputsChangeRequest
	{0x0F12,	0x0001 },

	{ 0xffff, 0xffff },
};

regval16_t ss6AA_output_1280x960_table[] =
{
	{0x0028,    0x7000 },
//cut screen to 4:3
	{0x002A, 	0x020A },	//#REG_TC_GP_PrevZoomReqInputWidth
...
regval16_t ss6AA_output_1280x768_table[] =
{
	{0x0028,    0x7000 },
	//cut screen to 1280x768
	{0x002A, 	0x020A },	//#REG_TC_GP_PrevZoomReqInputWidth
	{0x0F12, 	0x0500 },
	{0x002A, 	0x020c },	//#REG_TC_GP_PrevZoomReqInputHeight
	{0x0F12, 	0x0300 },
...
regval16_t ss6AA_340x272_table[] =
{
//PREVIEW CONFIGURATION 0 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0242 }, 
	{ 0x0F12, 340 }, //preview 3 width
	{ 0x0F12, 272 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
	{ 0x0F12, 0x0000 }, //clockind
	{ 0x0F12, 0x0002 },//frame time type
	{ 0x0F12, 0x0001 },//frame quality
	{ 0x0F12, 0x0168 }, //max frame time 3E8:10FPS  1F4:20FPS 14F:30FPS
	{ 0x0F12, 0x0168 }, //min frame time
	{ 0x0F12, 0x0000 }, //Saturation
	{ 0x0F12, 0x0000 }, //sharpness
	{ 0x0F12, 0x0000 }, //gamma
	{ 0x0F12, 0x0000 }, //color temp
	{ 0x0F12, 0x0000 }, //device gamma index
	{ 0x002A, 0x0262 }, //////////////////priv config0 mirror
	{ 0x0F12, 0x0000 }, //preview mirror
	{ 0x0F12, 0x0000 }, //capture mirror
	
//PREVIEW
	{ 0x002A, 0x03B6 },
	{ 0x0F12, 0x0000 },//Set flash mode
	{ 0x002A, 0x03FA },
	{ 0x0F12, 0x0001 },//mipi lans
	{ 0x0F12, 0x00C3 },
	{ 0x0F12, 0x0001 },
	{ 0x002A, 0x021C },
	{ 0x0F12, 0x0000 },//active
	{ 0x002A, 0x0220 },
	{ 0x0F12, 0x0001 },
	{ 0x002A, 0x01F8 },
	{ 0x0F12, 0x0001 },
...
regval16_t ss6AA_352x288_table[] =
{
//CONFIGURATION 0 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0242 }, 
	{ 0x0F12, 352 }, //preview 3 width
	{ 0x0F12, 288 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
...
regval16_t ss6AA_1280x1024_table[] =
{
//previw CONFIGURATION 0 (hd YUV, 15fps)  
	{ 0x0028, 0x7000 },
	{ 0x002A, 0x0242 }, //preview 0
	{ 0x0F12, 0x0500 }, //preview 0 width
	{ 0x0F12, 0x0400 }, //preview 0 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M  30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask 
	{ 0x0F12, 0x0001 }, //clockind
	{ 0x0F12, 0x0002 },//frame time type
	{ 0x0F12, 0x0002 },//frame quality
	{ 0x0F12, 0x0535 }, //max frame time 3E8:10FPS 29A:FPS
	{ 0x0F12, 0x0535 }, //min frame time
	{ 0x0F12, 0x0000 }, //Saturation
	{ 0x0F12, 0x0000 }, //sharpness
	{ 0x0F12, 0x0000 }, //gamma
	{ 0x0F12, 0x0000 }, //color temp
...
//PREVIEW
	...
	{ 0x002A, 0x021C },
	{ 0x0F12, 0x0000 },//active prevconfig:0,1,
	{ 0x002A, 0x0220 },
...
regval16_t ss6AA_320x180_table[] =
{
//PREVIEW CONFIGURATION 1 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0268 }, 
	{ 0x0F12, 320 }, //preview 3 width
	{ 0x0F12, 180 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
	...
	{ 0x0F12, 0x0000 }, //color temp
	{ 0x0F12, 0x0000 }, //device gamma index
	{ 0x002A, 0x0288 }, ///////////////////prev config1 mirror 
	{ 0x0F12, 0x0000 }, //preview mirror
	{ 0x0F12, 0x0000 }, //capture mirror
//PREVIEW
	{ 0x002A, 0x03B6 },
...
regval16_t ss6AA_480x272_table[] =
{
////////////////////////////////////
//PREVIEW CONFIGURATION 1 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0268 }, 
	{ 0x0F12, 480 }, //preview 3 width
	{ 0x0F12, 272 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
...
regval16_t ss6AA_512x288_table[] =
{
//PREVIEW CONFIGURATION 1 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0268 }, 
	{ 0x0F12, 512 }, //preview 3 width
	{ 0x0F12, 288 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
...
regval16_t ss6AA_640x360_table[] =
{
//PREVIEW CONFIGURATION 1 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x0268 }, 
	{ 0x0F12, 640 }, //preview 3 width
	{ 0x0F12, 360 }, //preview 3 height
	{ 0x0F12, 0x0005 }, //format
	{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
	{ 0x0F12, 0x30D4 }, //MIN PLCK
	{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
...
regval16_t ss6AA_1280x720_table[] =
{
//preview CONFIGURATION 1 (1280x1024 YUV, 7.5fps)
	{ 0x0028, 0x7000 },   	
...
//capture active
	...
	{ 0x0F12, 0x0000 },//Set flash mode
	{ 0x002A, 0x03FA },
	{ 0x0F12, 0x0001 },//number of mipi lanes
	{ 0x0F12, 0x00C3 },
	{ 0x0F12, 0x0001 },
	{ 0x002A, 0x021C },
	{ 0x0F12, 0x0001 },//active
...
regval16_t ss6AA_320x240_table[] =
{
////////////////////////////////////
//PREVIEW CONFIGURATION 2 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x028E }, 
	{ 0x0F12, 320 }, 
	{ 0x0F12, 240 },
	...
	{ 0x0F12, 0x0000 }, //color temp
	{ 0x0F12, 0x0000 }, //device gamma index
	{ 0x002A, 0x02AE }, //////////////////priv config2 mirror
	{ 0x0F12, 0x0000 }, //preview mirror
	{ 0x0F12, 0x0000 }, //capture mirror
...
regval16_t ss6AA_364x272_table[] =
{
//PREVIEW CONFIGURATION 2 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x028E }, 
...
regval16_t ss6AA_384x288_table[] =
{
//PREVIEW CONFIGURATION 2 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x028E }, 
...
regval16_t ss6AA_640x480_table[] =
{
//PREVIEW CONFIGURATION 2 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x028E }, 
...
regval16_t ss6AA_1280x960_table[] =
{
//PREVIEW CONFIGURATION 2 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x028E }, 
	...
	{ 0x002A, 0x02AE }, //prev config2 mirror 
	{ 0x0F12, 0x0000 }, 
	{ 0x0F12, 0x0000 },
...
regval16_t ss6AA_480x288_table[] =
{
//PREVIEW CONFIGURATION 4 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x02DA }, 
	{ 0x0F12, 480 }, 
	{ 0x0F12, 288 },
	...
	{ 0x0F12, 0x0000 }, //color temp
	{ 0x0F12, 0x0000 }, //device gamma index
	{ 0x002A, 0x02FA }, //////////////////priv config2 mirror
	{ 0x0F12, 0x0000 }, //preview mirror
	{ 0x0F12, 0x0000 }, //capture mirror
...
regval16_t ss6AA_1280x768_table[] =
{
//PREVIEW CONFIGURATION 4 (VGA, YUV)
	{ 0x0028, 0x7000 }, 
	{ 0x002A, 0x02DA }, 
	...
	{ 0x002A, 0x02FA }, //prev config2 mirror 
	{ 0x0F12, 0x0000 }, 
	{ 0x0F12, 0x0000 },
...
{ 
	...
	data[0] = 0x00; 
	data[1] = 0x70;
	nRet = gp_i2c_bus_write(g_i2c_handle, data, 2);
	//0x002e -> addr 
	addr[0] = 0x2e;
	addr[1] = 0x00;
	nRet = gp_i2c_bus_write(g_i2c_handle, addr, 2);
	...
	while (vals->reg_num != 0xffff || vals->value != 0xffff) {
		for(i = 0; i< 10; i++) {
			...
			if(nRet >= 0) {
				...
				while(1) {
					nRet = sensor_i2c_write(vals->reg_num, vals->value);
					printk("####CMOS:sensor I2C retry\n");
					if(nRet >= 0) {
						break;
					}
				}
			}else {
				printk("##CMOS:I2C Fail\n");
			}
		}
		if(i == 10) return -1;
		vals++;
...
{		
	...
	case CSI_IMAGE_GET_CONTRAST:		
		sensor_i2c_read(0x01E6, &data);
		ctrl->value = data;
		printk("[%s][%d]CSI_IMAGE_GET_CONTRAST: %d!\n", __FUNCTION__, __LINE__, ctrl->value);
		break;

	case CSI_IMAGE_GET_BRIGHTNESS:
		sensor_i2c_read(0x01E4, &data);
		ctrl->value = data;
		printk("[%s][%d]CSI_IMAGE_GET_BRIGHTNESS: %d!\n", __FUNCTION__, __LINE__, ctrl->value);
		break;

	case CSI_IMAGE_GET_SATURATION:
		sensor_i2c_read(0x01E8, &data);
		ctrl->value = data;
		printk("[%s][%d]CSI_IMAGE_GET_SATURATION: %d!\n", __FUNCTION__, __LINE__, ctrl->value);
		break;

	case CSI_IMAGE_GET_SHARPNESS:
		sensor_i2c_read(0x01EA, &data);
		ctrl->value = data;
		printk("[%s][%d]CSI_IMAGE_GET_SHARPNESS: %d!\n", __FUNCTION__, __LINE__, ctrl->value);
		break;

	case CSI_IMAGE_GET_WHITEBALANCE:
		sensor_i2c_read(0x0400, &data);
		if(data == 0x007F)
		{
			ctrl->value = 0;//auto
		}else{
			sensor_i2c_read(0x03D0, &data);
			if(data == 0x0790)
			{
				ctrl->value = 1;
			}else if(data == 0x05D0){
				...
				printk("[%s][%d]CSI_IMAGE_GET_WHITEBALANCE: data error!\n", __FUNCTION__,  __LINE__);
			}
		}
		break;

	case CSI_IMAGE_GET_HZ:
		sensor_i2c_read(0x03DC, &data);
		if(data == 0x0001)
		{
			ctrl->value = 50;
		}else{
	...
	case CSI_IMAGE_GET_MIRROR:
		printk("[%s]CSI_IMAGE_GET_MIRROR\n", __FUNCTION__);

		if(((g_sensor_dev.fmt->hpixel ==  340)&&(g_sensor_dev.fmt->vline == 272))//340x272 prev conf0:0x0242
		 ||((g_sensor_dev.fmt->hpixel ==  352)&&(g_sensor_dev.fmt->vline == 288))//352x288 prev conf0:0x0242
		 ||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 1024))//1280x1024 prev conf0:0x0242
		)
		{
			sensor_i2c_read(0x0262, &data);
		}else if(((g_sensor_dev.fmt->hpixel ==  320)&&(g_sensor_dev.fmt->vline == 180))//320x180 prev conf1:0x0268
		||((g_sensor_dev.fmt->hpixel ==  480)&&(g_sensor_dev.fmt->vline == 272))//480x272 prev conf1:0x0268
		||((g_sensor_dev.fmt->hpixel ==  512)&&(g_sensor_dev.fmt->vline == 288))//512x288 prev conf1:0x0268
		||((g_sensor_dev.fmt->hpixel ==  640)&&(g_sensor_dev.fmt->vline == 360))//640x360 prev conf1:0x0268
		||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 720))//1280x720 prev conf1:0x0268
		)
		{
			sensor_i2c_read(0x0288, &data);
		}else if(((g_sensor_dev.fmt->hpixel ==  320)&&(g_sensor_dev.fmt->vline == 240))//320x240 prev conf4:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  364)&&(g_sensor_dev.fmt->vline == 272))//364x272 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  384)&&(g_sensor_dev.fmt->vline == 288))//384x288 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  640)&&(g_sensor_dev.fmt->vline == 480))//640x480 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 960))//1280x960 prev conf1:0x02E8
		){
			sensor_i2c_read(0x02AE, &data);
		}else if(((g_sensor_dev.fmt->hpixel ==  480)&&(g_sensor_dev.fmt->vline == 288))//480x288 prev conf3:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 768))//1280x768 prev conf1:0x02E8
		){
			sensor_i2c_read(0x02FA, &data);
		}else{
			sensor_i2c_read(0x02DA, &data);
...
/*
	...
	{
		printk("[%s][%d]parameter value error, range: -127(0xFF81)~127(0x007F)!\n", __FUNCTION__,  __LINE__);
		return -1;
	}
*/
#if 0
	...
	case CSI_IMAGE_SET_CONTRAST:
		printk("[%s]SET_CONTRAST at %d\n", __FUNCTION__, ctrl->value);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x01E6);
		sensor_i2c_write(0x0F12, ctrl->value);
		break;


	case CSI_IMAGE_SET_BRIGHTNESS:
		printk("[%s]SET_BRIGHTNESS at %d\n", __FUNCTION__, ctrl->value);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x01E4);
		sensor_i2c_write(0x0F12, ctrl->value);		
		break; 
 

	case CSI_IMAGE_SET_SATURATION:
		printk("[%s]SET_SATURATION at %d\n", __FUNCTION__, ctrl->value);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x01E8);
		sensor_i2c_write(0x0F12, ctrl->value);			
		break;



	case CSI_IMAGE_SET_SHARPNESS:
		printk("[%s]SET_SHARPNESS at %d\n", __FUNCTION__, ctrl->value);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x01EA);
		sensor_i2c_write(0x0F12, ctrl->value);			
		break;


	//WHITE BALANCE MODE:
	case CSI_IMAGE_SET_WHITEBALANCE:
		if(ctrl->value == 0)
		{
			printk("[WHITE_BALANCE]AUTO\n");
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0400);
			sensor_i2c_write(0x0F12, 0x007F);
			break;
		}else if(ctrl->value == 1){
			printk("[WHITE_BALANCE]CLOUDY\n");
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0400);
			sensor_i2c_write(0x0F12, 0x0077);//0x7000 0400      0x0077

			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x03D0);
			sensor_i2c_write(0x0F12, 0x0790);//0x7000 03D0     0x0790  //R gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000  03D2     0x0001
			sensor_i2c_write(0x0F12, 0x0400);//0x7000 03D4     0x0400  //G gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			sensor_i2c_write(0x0F12, 0x0480);//0x7000  03D8     0x0480 //B gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			break;

		}else if(ctrl->value == 2){
			printk("[WHITE_BALANCE]DAYLIGHT\n");
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0400);
			sensor_i2c_write(0x0F12, 0x0077);//0x7000 0400      0x0077
			...
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x03D0);
			sensor_i2c_write(0x0F12, 0x05D0);//0x7000 03D0      0x05D0  //R gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000  03D2     0x0001
			sensor_i2c_write(0x0F12, 0x0400);//0x7000 03D4      0x0400  //G gain  
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			sensor_i2c_write(0x0F12, 0x04C0);//0x7000 03D8      0x04C0  //B gain  
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			break;

		}else if(ctrl->value == 3){
			printk("[WHITE_BALANCE]FLUORESCENT\n");
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0400);
			sensor_i2c_write(0x0F12, 0x0077);//0x7000 0400      0x0077
			...
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x03D0);
			sensor_i2c_write(0x0F12, 0x05A0);//0x7000 03D0      0x05A0  //R gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000  03D2     0x0001
			sensor_i2c_write(0x0F12, 0x0400);//0x7000 03D4      0x0400  //G gain  
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			sensor_i2c_write(0x0F12, 0x07C0);//0x7000  03D8      0x07C0 //B gain  
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			break;

		}else if(ctrl->value == 4){
			printk("[WHITE_BALANCE]INCANDESCENT\n");
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0400);
			sensor_i2c_write(0x0F12, 0x0077);//0x7000 0400      0x0077
			...
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x03D0);
			sensor_i2c_write(0x0F12, 0x0400);//0x7000 03D0      0x0400  //R gain
			sensor_i2c_write(0x0F12, 0x0001);//0x7000  03D2     0x0001
			sensor_i2c_write(0x0F12, 0x0400);//0x7000 03D4      0x0400  //G gain  
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			sensor_i2c_write(0x0F12, 0x0900);//0x7000 03D8      0x0900  //B gain 
			sensor_i2c_write(0x0F12, 0x0001);//0x7000 03D6      0x0001
			break;

		}else {
			printk("[WHITE_BALANCE]parameter error, range from 0 to 4.\n");

		}
		break;		

	case CSI_IMAGE_SET_50HZ:
		printk("[%s]SET_CSI_50HZ\n", __FUNCTION__);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x0400);
		sensor_i2c_write(0x0F12, 0x005F);
		sensor_i2c_write(0x002A, 0x03DC);
		sensor_i2c_write(0x0F12, 0x0001);
		sensor_i2c_write(0x0F12, 0x0001);				
		break;	

	case CSI_IMAGE_SET_60HZ:
		printk("[%s]SET_CSI_60HZ\n", __FUNCTION__);
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x0400);
		sensor_i2c_write(0x0F12, 0x005F);
		sensor_i2c_write(0x002A, 0x03DC);
		sensor_i2c_write(0x0F12, 0x0002);
		sensor_i2c_write(0x0F12, 0x0001);
		break;

	case CSI_IMAGE_SET_MIRROR:
		printk("[%s]CSI_IMAGE_MIRROR\n", __FUNCTION__);
		if(((g_sensor_dev.fmt->hpixel ==  340)&&(g_sensor_dev.fmt->vline == 272))//340x272 prev conf0:0x0242
		 ||((g_sensor_dev.fmt->hpixel ==  352)&&(g_sensor_dev.fmt->vline == 288))//352x288 prev conf0:0x0242
		 ||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 1024))//1280x1024 prev conf0:0x0242
		)
		{
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0262);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x002A, 0x021C);
			sensor_i2c_write(0x0F12, 0x0000);//active priv0
		...
		{
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x0288);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x002A, 0x021C);
			sensor_i2c_write(0x0F12, 0x0001);//active priv1
		}else if(((g_sensor_dev.fmt->hpixel ==  320)&&(g_sensor_dev.fmt->vline == 240))//320x240 prev conf4:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  364)&&(g_sensor_dev.fmt->vline == 272))//364x272 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  384)&&(g_sensor_dev.fmt->vline == 288))//384x288 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  640)&&(g_sensor_dev.fmt->vline == 480))//640x480 prev conf1:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 960))//1280x960 prev conf1:0x02E8
			...
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x02AE);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x002A, 0x021C);
			sensor_i2c_write(0x0F12, 0x0002);//active priv2
		}else if(((g_sensor_dev.fmt->hpixel ==  480)&&(g_sensor_dev.fmt->vline == 288))//480x288 prev conf3:0x02E8
		||((g_sensor_dev.fmt->hpixel ==  1280)&&(g_sensor_dev.fmt->vline == 768))//1280x768 prev conf1:0x02E8
		){
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x02FA);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x002A, 0x021C);
			sensor_i2c_write(0x0F12, 0x0002);//active priv4
		}else{
			sensor_i2c_write(0x0028, 0x7000);
			sensor_i2c_write(0x002A, 0x02DA);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x0F12, ctrl->value);
			sensor_i2c_write(0x002A, 0x021C);
			sensor_i2c_write(0x0F12, 0x0002);//active priv3
		}

		break;

	case CSI_IMAGE_SET_DEFAULT:
		sensor_i2c_write(0x0028, 0x7000);
		sensor_i2c_write(0x002A, 0x01E6);
		sensor_i2c_write(0x0F12, 0x0000);

		sensor_i2c_write(0x002A, 0x01E4);//BRIGHTNESS
		sensor_i2c_write(0x0F12, 0x0000);	

		sensor_i2c_write(0x002A, 0x01E8);//SATURATION
		sensor_i2c_write(0x0F12, 0x0000);			
	
		sensor_i2c_write(0x002A, 0x01EA);//SHARPNESS
		sensor_i2c_write(0x0F12, 0x0000);			
		
		sensor_i2c_write(0x002A, 0x0400);//WHITEBALANCE auto
		sensor_i2c_write(0x0F12, 0x007F);
...
static int 
sensor_any_resolution(
	int width,
	int height
)
{
	int nRet = 0;
	regval16_t any_resolution_output_table[] =
	{
		  //cut screen
		{0x0028,    0x7000 }, 
		{0x002A, 	0x020A },	//#REG_TC_GP_PrevZoomReqInputWidth
		...
		{0x0F12,	0x0000 },
		{0x002A,	0x0200 },	//#REG_TC_GP_PrevInputHeightOfs	//centered 
		{0x0F12,	(1024 - (1280*(height/width)))/2 },	
		{0x002A, 	0x021A },//#REG_TC_GP_InputsChangeRequest
		{0x0F12, 	0x0001 },
	...
	regval16_t any_resolution_table[] =
	{
	//PREVIEW CONFIGURATION 3 (VGA, YUV)
		{ 0x0028, 0x7000 }, 

		{ 0x002A, 0x02B4 }, //privew config addr
		{ 0x0F12, width }, //width
		{ 0x0F12, height }, //height
		{ 0x0F12, 0x0005 }, //format
		{ 0x0F12, 0x30D4 }, //MAX PLCK 2EE0:12M 30D4:12.5M
		{ 0x0F12, 0x30D4 }, //MIN PLCK
		{ 0x0F12, 0x0040 | C_SS6AA_FMT }, //yuv PVIMask
	...
	printk("%s\n", __FUNCTION__);
	nRet = sensor_write_table(any_resolution_output_table);
	msleep(100);
	nRet = sensor_write_table(any_resolution_table);
	msleep(100);
	nRet = sensor_write_table(any_resolution_output_table);
	return nRet;
}
...
)
{
	...
	printk("%s\n", __FUNCTION__);
	printk("%s\n", "start: size of #######################################################################");
	if((fmt->fmt.pix.width == 340) && (fmt->fmt.pix.height == 272)) {//340x272 5:4
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_340x272_table);
		msleep(200);
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);
		
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_340x272_table");
	} else if ((fmt->fmt.pix.width == 352) && (fmt->fmt.pix.height == 288)) {//360x288 5:4
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_352x288_table);
		msleep(200);
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);
	
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_352x288_table");
	} else if ((fmt->fmt.pix.width == 1280) && (fmt->fmt.pix.height == 1024)) {//1280x1024 5:4
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_1280x1024_table);	
		msleep(200);
		nRet = sensor_write_table(ss6AA_output_1280x1024_table);


		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_1280x1024_table");

	} else if ((fmt->fmt.pix.width == 320) && (fmt->fmt.pix.height == 180)) {//320x180 16:9
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_320x180_table);
		msleep(200);		
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_320x180_table");
	} else if ((fmt->fmt.pix.width == 480) && (fmt->fmt.pix.height == 272)) {//480x272 16:9
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_480x272_table);
		msleep(200);		
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_480x272_table");
	} else if ((fmt->fmt.pix.width == 512) && (fmt->fmt.pix.height == 288)) {//512x288 16:9
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_512x288_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x720_table);
		
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_512x288_table");
	} else if ((fmt->fmt.pix.width == 640) && (fmt->fmt.pix.height == 360)) {//640x360 16:9
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_640x360_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x720_table);
//		msleep(100);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_640x360_table");
	} else if ((fmt->fmt.pix.width == 1280) && (fmt->fmt.pix.height == 720)) {//1280x720 16:9
		nRet = sensor_write_table(ss6AA_output_1280x720_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_1280x720_table);	
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x720_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_1280x720_table");

	} else if ((fmt->fmt.pix.width == 320) && (fmt->fmt.pix.height == 240)) {//320x240  4:3
		nRet = sensor_write_table(ss6AA_output_1280x960_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_320x240_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x960_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_320x240_table");
	} else if ((fmt->fmt.pix.width == 364) && (fmt->fmt.pix.height == 272)) {//364x272  4:3
		nRet = sensor_write_table(ss6AA_output_1280x960_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_364x272_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x960_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_364x272_table");
	} else if ((fmt->fmt.pix.width == 384) && (fmt->fmt.pix.height == 288)) {//384x288  4:3
		nRet = sensor_write_table(ss6AA_output_1280x960_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_384x288_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x960_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_384x288_table");
	} else if ((fmt->fmt.pix.width == 640) && (fmt->fmt.pix.height == 480)) {//640x480  4:3
		nRet = sensor_write_table(ss6AA_output_1280x960_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_640x480_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x960_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_640x480_table");
	} else if ((fmt->fmt.pix.width == 1280) && (fmt->fmt.pix.height == 960)) {//1280x960  4:3
		nRet = sensor_write_table(ss6AA_output_1280x960_table);
		msleep(100);

		nRet = sensor_write_table(ss6AA_1280x960_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x960_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_1280x960_table");

	} else if ((fmt->fmt.pix.width == 480) && (fmt->fmt.pix.height == 288)) {//480x288  
		nRet = sensor_write_table(ss6AA_output_1280x768_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_480x288_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x768_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_480x288_table");
	} else if ((fmt->fmt.pix.width == 1280) && (fmt->fmt.pix.height == 768)) {//1280x768 
		nRet = sensor_write_table(ss6AA_output_1280x768_table);
		msleep(100);
		nRet = sensor_write_table(ss6AA_1280x768_table);
		msleep(200);
        nRet = sensor_write_table(ss6AA_output_1280x768_table);
		printk("%s\n", "[csi_mipi.c][sensor_s_fmt]ss6AA_1280x768_table");
 
	} else {
		nRet = sensor_any_resolution(fmt->fmt.pix.width, fmt->fmt.pix.height);//for any resolution, manual set resolution
		printk("[csi_mipi.c][sensor_s_fmt]write munual set resolution:%d*%d\n", fmt->fmt.pix.width, fmt->fmt.pix.height);
	}
...
{
	if(sensor_i2c_open(SS_6AA_ID, 100) == 0)
	{
		printk(KERN_WARNING "i2cReqFail %d\n", g_i2c_handle);
		return -1;
	}
