...
int main(int argc, char *argv[])
{
	...
	/* Use alpha blending */
	SDL_SetAlpha(screen, SDL_SRCALPHA, 200); /*old alpha is 0, the src transparent all color, it should bigger than 0 */
	/* Set title for window */
	SDL_WM_SetCaption(title,title);
	/* Do all the drawing work */
	Draw(screen);
	
	/*WaitForEvent();*/ /*SPMP8050 always has a key pressed, so this process will exit itself*/
	while(1) { /*to keep this test*/
	}
