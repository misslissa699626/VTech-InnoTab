...
/*
 * NAME:	field->id3_field_getlatin1s()
 * DESCRIPTION:	return the value of a full latin1list field
 */
id3_latin1_t const *id3_field_getlatin1s(union id3_field const *field,unsigned int index)
{
  ...
  return field->latin1list.strings[index] ? field->latin1list.strings[index] : (id3_latin1_t const *) "";
}
/*
 * NAME:	field->id3_field_getnlatin1s()
 * DESCRIPTION:	return the number of strings in latin1list field
 */
unsigned int  id3_field_getnlatin1s(union id3_field const *field)
{
  assert(field);
  ...
  return field->latin1list.nstrings;
}
...
/*
 * NAME:	field->getstrings_ex()
 * DESCRIPTION:	return one value of a stringlist field
 */
id3_ucs4_t const *id3_field_getstrings_ex(char**ptr,union id3_field const *field,
				       unsigned int index)
{
  id3_ucs4_t const *string;
  id3_length_t size = 0;
  ...
  string = field->stringlist.strings[index];
    size = 0;
      size += id3_render_string(ptr, field->stringlist.strings[index], encoding,
				(index < field->stringlist.nstrings - 1));
  return string ? string : id3_ucs4_empty;
}
