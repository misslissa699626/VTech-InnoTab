...
#define SPMP_TC_MAGIC		'T'

#define TC_IOCTL_ENABLE			_IO(SPMP_TC_MAGIC,0x01)
#define TC_IOCTL_DISABLE		_IO(SPMP_TC_MAGIC,0x02)

#define TC_IOCTL_ENABLE_OUTPUT		_IOW(SPMP_TC_MAGIC,0x03,unsigned int)
#define TC_IOCTL_SET_COUNT_MODE		_IOW(SPMP_TC_MAGIC,0x04,unsigned int)
#define TC_IOCTL_SET_COUNT_SELECTION	_IOW(SPMP_TC_MAGIC,0x05,unsigned int)
#define TC_IOCTL_SET_PULSE_MODE		_IOW(SPMP_TC_MAGIC,0x06,unsigned int)
#define TC_IOCTL_SET_ACTIVE_EDGE	_IOW(SPMP_TC_MAGIC,0x07,unsigned int)
#define TC_IOCTL_SET_OPERATION_MODE	_IOW(SPMP_TC_MAGIC,0x08,unsigned int)
#define TC_IOCTL_SET_RELOAD		_IOW(SPMP_TC_MAGIC,0x09,unsigned int)
#define TC_IOCTL_GET_CURRENT_VALUE	_IOR(SPMP_TC_MAGIC,0x0a,unsigned int)
#define TC_IOCTL_SET_PRESCALE		_IOW(SPMP_TC_MAGIC,0x0b,unsigned int)
#define TC_IOCTL_GET_PRESCALE		_IOR(SPMP_TC_MAGIC,0x0c,unsigned int)
#define TC_IOCTL_SET_COMPARE		_IOW(SPMP_TC_MAGIC,0x0d,unsigned int)
#define TC_IOCTL_GET_COMPARE		_IOR(SPMP_TC_MAGIC,0x0e,unsigned int)
