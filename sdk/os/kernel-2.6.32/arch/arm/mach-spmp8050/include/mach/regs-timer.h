...
#define TMLDR_0   (*(volatile unsigned int*)(TIMER0_BASE+0x08))  //load value Register
#define TMVLR_0   (*(volatile unsigned int*)(TIMER0_BASE+0x0c))  //interrupt register
...
#define TMLDR_1   (*(volatile unsigned int*)(TIMER1_BASE+0x08))  //load value Register
#define TMVLR_1   (*(volatile unsigned int*)(TIMER1_BASE+0x0c))  //interrupt register
...
#define TMLDR_2   (*(volatile unsigned int*)(TIMER2_BASE+0x08))  //load value Register
#define TMVLR_2   (*(volatile unsigned int*)(TIMER2_BASE+0x0c))  //interrupt register
...
#define TMLDR_3   (*(volatile unsigned int*)(TIMER3_BASE+0x08))  //load value Register
#define TMVLR_3   (*(volatile unsigned int*)(TIMER3_BASE+0x0c))  //interrupt register
...
#define TMLDR_4   (*(volatile unsigned int*)(TIMER4_BASE+0x08))  //load value Register
#define TMVLR_4   (*(volatile unsigned int*)(TIMER4_BASE+0x0c))  //interrupt register
