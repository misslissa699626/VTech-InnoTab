...
{
    scuaReg_t* pscua = (scuaReg_t*)LOGI_ADDR_SCU_A_REG;

    pscua->scuaPeriClkEn |= SCU_A_PERI_LINEBUFFER;
}
*/
/**
...
)
{
    ...
    /*printk("\nrectwh:%x,desire:%x,%x.", g2dReg->g2dRectWH, popRect->width, popRect->height);*/
...
)
{
    ...
    case G2DENG_MSK_ENABLE_MSKBLT:
        g2dReg->bgPatternRop =
            ((bgRop & ATTR_2D_ROP_MSK)<<ATTR_2D_ROP_OFFSET) | (bgPattern&ATTR_2D_ROP_PATTERN_MSK);
