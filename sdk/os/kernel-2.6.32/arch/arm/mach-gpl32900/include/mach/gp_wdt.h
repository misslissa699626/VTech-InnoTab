 ...
 */
#define SPMP_WDT_MAGIC		'W'

#define WDT_IOCTL_CTRL		_IO(SPMP_WDT_MAGIC,0x01)		/*!< @brief watchdog enable/disable control */	
#define WDT_IOCTL_KEEPALIVE	_IO(SPMP_WDT_MAGIC,0x02)		/*!< @brief watchdog feed */	
#define WDT_IOCTL_FORCERESET	_IO(SPMP_WDT_MAGIC,0x03)		/*!< @brief watchdog force reset system */	
#define WDT_IOCTL_SETTIMEROUT	_IOW(SPMP_WDT_MAGIC,0x04,unsigned int)	/*!< @brief watchdog set timerout */
#define WDT_IOCTL_GETTIMEROUT	_IOR(SPMP_WDT_MAGIC,0x05,unsigned int)	/*!< @brief watchdog get timerout */
