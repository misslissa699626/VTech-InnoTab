...
#define LOGO_ADDR_SPI1_REG		(IO2_BASE + 0xb09000)
#define LOGO_ADDR_SPI1_IOREG	(IO0_BASE + 0x5144)//0x90005144
...
/*line control register setting*/
#define		SSI1EN				0x10	/*SSI normal/network mode enable*/
#define 	SBL1EN				0x08	/*fram sysc type(SSI mode enable)*/
#define 	CONT1				0x04	/*clock tyoe(SSI mode only)*/
#define		MODE_SSI1_Network	0x03	/**/
#define		MODE_SSI1_OnDemand	0x02
#define		MODE_SSI1_Normal	0x01
#define		MODE_SPI1			0x00
/**************************************************************************
 *                          D A T A    T Y P E S                          *
 **************************************************************************/
