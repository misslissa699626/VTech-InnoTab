...
#define CHUNK_MEM_DUMP          _IOR(CHUNK_MEM_IOCTL_MAGIC,  15, unsigned int)
#define CHUNK_MEM_FREEALL       _IOW(CHUNK_MEM_IOCTL_MAGIC,  16, unsigned int)
