...
#define GPIO_GID_MAX            34
/* GID for pins without gid */
#define GPIO_GID_UNKOWN         (GPIO_GID_MAX + 1)
...
#define	GPIO_IOCTL_SET_INPUT	_IOW(GPIO_IOCTL_ID, 2, gpio_content_t)
#define	GPIO_IOCTL_GET_VALUE_DIRECT	_IOW(GPIO_IOCTL_ID, 3, gpio_content_t)
#define	GPIO_IOCTL_SET_VALUE_DIRECT	_IOW(GPIO_IOCTL_ID, 4, gpio_content_t)
