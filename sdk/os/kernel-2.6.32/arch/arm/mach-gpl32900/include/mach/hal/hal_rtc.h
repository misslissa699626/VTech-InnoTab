...
#else	/*Keep logical identifier for timercnt, in 32900 it is same as LOADCNTBIT in phy*/

#define RTC_TIMERCNT_7_0_MARCO   (0x10)   /*The counting value of the timer*/
#define RTC_TIMERCNT_15_8_MARCO  (0x11)
#define RTC_TIMERCNT_23_16_MARCO (0x12)
#define RTC_TIMERCNT_31_24_MARCO (0x13)
#define RTC_TIMERCNT_39_32_MARCO (0x14)
#define RTC_TIMERCNT_47_40_MARCO (0x15)
#endif
...
extern void gpHalRtcIntEnable(UINT8 IntEn, UINT8 IntEnMask);

extern UINT32 gpHalRtcGetTime(UINT32 *pvalue);

extern UINT32 gpHalRtcSetTime(UINT32 time);

extern UINT32 gpHalRtcGetAlarmStatus(UINT8 *enable, UINT8 *pending, UINT32 *time);

extern UINT32 gpHalRtcSetAlarmStatus(UINT8 enable, UINT8 pending, UINT32 time);

extern UINT32 gpHalRtcEnable(UINT8 enable);
