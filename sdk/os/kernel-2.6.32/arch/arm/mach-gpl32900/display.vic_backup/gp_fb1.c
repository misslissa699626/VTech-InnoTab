...
static char driver_name[] = "gp-fb1";
...
)
{
	...
	disp1_set_pri_bitmap(&priBitmap);

	/* Enable primary */
	disp1_set_pri_enable(1);
...
MODULE_DESCRIPTION("GP frame buffer 1 driver");
MODULE_LICENSE_GP;
