...
)
{
  ...
  audio2_HDPHN_volget(&l_lvl, &r_lvl);
...
)
{
  ...
  audio2_HDPHN_volset((long)l_lvl, (long)r_lvl);
...
)
{
  ...
  audio2_WAVE_volget(&l_lvl, &r_lvl);
...
)
{
  ...
  audio2_WAVE_volset((long)l_lvl, (long)r_lvl);
...
)
{
  ...
  audio2_LINEIN_volget(&l_lvl, &r_lvl);
...
)
{
  ...
  audio2_LINEIN_volset((long)l_lvl, (long)r_lvl);
...
)
{
  ...
  audio2_WAVE_muteget(&l_mute, &r_mute);
...
)
{
  ...
  audio2_WAVE_muteset((long)l_mute, (long)r_mute);
  audio2_LINEOUT_muteset((long)l_mute, (long)r_mute);
