...
#endif
printk("save_processor_state\n");
    save_processor_state();
printk("gpfb_save_snapshot\n");
    /* Snapshot save */
    ret = gpfb_save_snapshot();
printk("restore_processor_state\n");
    pm_device_down = GPFB_STATE_RESUME;
