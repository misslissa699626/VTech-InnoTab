...
#define MAX_NUM_PART						(6+1)	// Maximum number per chip: 6 partition + 1 placeholder
...
// $$ For testing.  Should be modified later
#define INNOTAB_NUM_OF_INT_PARTITION		1		/* 1 partition for testing */
