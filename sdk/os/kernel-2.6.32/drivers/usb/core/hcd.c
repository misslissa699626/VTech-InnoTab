			   ...
			   gfp_t mem_flags)
{
	...
	/* 
	To early here 
	if( usbStopInSetupPackGet() == 1 ) {
		printk("[%s][%d]IF TEST MODE - STOP in SETUP PACKET\n", __FUNCTION__, __LINE__);
		while(1) {
		}
	}*/
	return ret;
...
int stopInSetupPack = 0;
void usbStopInSetupPackSet (void) {
	stopInSetupPack = 1;
}

int usbStopInSetupPackGet (void) {
	return stopInSetupPack;
}

int stopInDataPack = 0;
void usbStopInDataStageSet(void) {
	stopInDataPack = 1;
}

int usbStopInDataStageGet (void) {
	return stopInDataPack;
}
