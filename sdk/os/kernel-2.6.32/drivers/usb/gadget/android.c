...
void android_register_function(struct android_usb_function *f)
{
	...
	//printk("[%s][%d], [%x][%x][%x][%x]\n",	__FUNCTION__, __LINE__, 
			 //(unsigned int)dev, (unsigned int)dev->config, _registered_function_count, dev->num_functions);
...
extern int mass_storage_init(void);
...
static int android_suspend(struct platform_device *pdev, pm_message_t message)
{
