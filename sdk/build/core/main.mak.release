...
# ###############################################################
.PHONY: all
all: buildspec kernel sdk product
...
kernel_release:
#ifeq ($(KERNEL_SRC_BASE),)
#	@$(ECHO) "Error: kernel base source directory not found!"
#else
#endif
ifeq ($(KERNEL_SRC),)
	@$(ECHO) "Error: kernel source not found!"
else
	@$(BIN_DIR)/script/kernel_release.sh
endif

.PHONY: kernel_release_32900
kernel_release_32900:
ifeq ($(KERNEL_SRC),)
	@$(ECHO) "Error: kernel source not found!"
else
	$(BIN_DIR)/script/kernel_release.sh 32900
endif
...
# Release
# ###############################################################
.PHONY: openplatform_release
openplatform_release:
	@$(BIN_DIR)/script/openplatform_release.sh
